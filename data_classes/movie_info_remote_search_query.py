...
class MovieInfoRemoteSearchQuery:
    ...
    search_info: Optional[MovieInfoClass] = None
    """Will only search within the given provider when set."""
    search_provider_name: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'MovieInfoRemoteSearchQuery':
        ...
        search_info = from_union([MovieInfoClass.from_dict, from_none], obj.get("SearchInfo"))
        search_provider_name = from_union([from_str, from_none], obj.get("SearchProviderName"))
        return MovieInfoRemoteSearchQuery(include_disabled_providers, item_id, search_info, search_provider_name)
    ...
    def to_dict(self) -> dict:
        ...
        result["SearchInfo"] = from_union([lambda x: to_class(MovieInfoClass, x), from_none], self.search_info)
