...
class SongInfo:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'SongInfo':
        ...
        return SongInfo(album, album_artists, artists, index_number, is_automated, metadata_country_code, metadata_language, name, parent_index_number, path, premiere_date, provider_ids, year)
