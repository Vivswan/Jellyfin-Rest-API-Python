...
class BookInfoClass:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'BookInfoClass':
        ...
        return BookInfoClass(index_number, is_automated, metadata_country_code, metadata_language, name, parent_index_number, path, premiere_date, provider_ids, series_name, year)
