...
class ArtistInfoRemoteSearchQuery:
    ...
    search_info: Optional[ArtistInfoClass] = None
    """Will only search within the given provider when set."""
    search_provider_name: Optional[str] = None

    @staticmethod
    def from_dict(obj: Any) -> 'ArtistInfoRemoteSearchQuery':
        ...
        search_info = from_union([ArtistInfoClass.from_dict, from_none], obj.get("SearchInfo"))
        search_provider_name = from_union([from_str, from_none], obj.get("SearchProviderName"))
        return ArtistInfoRemoteSearchQuery(include_disabled_providers, item_id, search_info, search_provider_name)
    ...
    def to_dict(self) -> dict:
        ...
        result["SearchInfo"] = from_union([lambda x: to_class(ArtistInfoClass, x), from_none], self.search_info)
