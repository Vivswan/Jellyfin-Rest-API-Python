...
class BaseItemDtoImageBlurHashes:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'BaseItemDtoImageBlurHashes':
        ...
        return BaseItemDtoImageBlurHashes(art, backdrop, banner, box, box_rear, chapter, disc, logo, menu, primary, profile, screenshot, thumb)
